...
from questions import HardQuestion
...
class HardGame:
    def __init__(self, display, gamestatemanager):
        ...
        self.user_text = ""
        input_x = (self.display.get_width() - 300) // 2
        ...
        while True:
            ...
            if not self.is_playing:
                if not self.start_message_displayed:
                    self.display.blit(self.start_background, (0, 0))  # Blit the start background image
